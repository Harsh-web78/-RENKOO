...
export class SeoAuditService {
  ...
  async auditPage(crawlPageId: string) {
     ...
     *
     * A canonical may be absolute or relative.
     */
    ...
    if (
      ...
      try {
         ...
         * -------------------------------------------------------
         *
         * Only ONE check exists here.
         * This prevents duplicate CANONICAL_CROSS_DOMAIN issues.
         */
        ...
        const normalizeUrl = (url: URL) => {
          ...
          /*
           * Hash fragments do not determine canonical
           * document identity.
           */
          normalized.hash = '';
        ...
        /*
         * Keep these values available for future
         * same-site canonical analysis.
         *
         * We intentionally do NOT mark a same-domain
         * canonical pointing to another URL as an error,
         * because cross-page canonicalization can be valid.
         */
        void normalizedPageUrl;
        void normalizedCanonicalUrl;
      } catch {
        /*
        ...
        issues.push({
          ...
          description:
            `The canonical value "${page.canonical}" is not a valid URL or relative URL.`,
          recommendation:
    ...
    if (page.imagesWithoutAlt > 0) {
      issues.push({
        ...
        recommendation:
          'Add descriptive alt text to meaningful images and avoid unnecessary alt text on decorative images.',
        status: SeoIssueStatus.OPEN,
      });
    }
     ...
     * Only OPEN issues from the previous audit are removed.
     */
