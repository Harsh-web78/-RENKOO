  ...
  async auditPage(crawlPageId: string) {
    ...
    if (!page.title || !page.title.trim()) {
      ...
      if (titleLength < 30) {
        addIssue(
          ...
          'Expand the title so it clearly communicates the page topic and search intent.',
        );
      }
    ...
    if (
      ...
      addIssue(
        ...
        'Add the important Open Graph metadata so shared pages have clear titles, descriptions and images.',
      );
    }
    ...
    /*
     * =========================================================
     * 14. JSON-LD VALIDITY SIGNAL
     * =========================================================
     *
     * The crawler stores parsed JSON-LD in jsonLd.
     * We only flag it when structured data exists but the
     * stored JSON-LD value is unexpectedly empty.
     */
    ...
    if (
      ...
      addIssue(
        ...
        'Clearly state what the page is about, who/what it represents and the user intent it serves.',
      );
    }
    ...
    /*
     * =========================================================
     * 26. REFRESH OPEN ISSUES
     * =========================================================
     *
     * FIXED and IGNORED issues are preserved.
     * Only OPEN issues from this page's previous audit
     * are replaced.
     */
